        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>FULL STACK & AI</h3>
              <h4>Scalable Apps & Intelligent Systems</h4>
              <p>
                Developing robust full-stack applications with a focus on
                integrating AI to enhance user experiences and automate
                complex processes.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Contributing to Global Projects</h4>
              <p>
                Deeply involved in open-source ecosystems like CHT Core and
                InVesalius, while applying data science principles from IIT
                Madras to solve real-world data challenges.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
